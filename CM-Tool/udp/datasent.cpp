...
void souceData_To_protcldata()
{
    ...
    msg.segment.filed.data = (quint8 *)malloc(sizeof(quint8)*BUFSIZ);
    fill_header(&msg);
...
void electricData_filled(data_packet *data ,electricData *packet)
{
    ...
    data->segment.filed.fn[1] = fc++ << 4;
    data->segment.filed.data = packet->switchStatus; //开关状态
    sent_msg_xor(data);
...
//    char buf[21] = { 0x7E, 0x5E ,0x01, 0x02 ,0x01, 0x01, 0x01, 0x01, 0x03, 0x00, 0x00, 0x00, 0x06, 0x00, 0x01, 0x18, 0x00, 0x01, 0x02, 0x1C ,0x23};
//    for(int i = 0 ; i< 21 ; i++)
//    {
//        array.append(buf[i]);
//    }
